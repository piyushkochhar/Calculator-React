...
import calculatorImg from "../../react-intro-class/calculator.png";
...
class Calculator extends Component{
    ...
    setDisplay(num) {
        ...
        this.setState({ display: (this.state.display.length < 13) ? display : this.state.display })
            ...
            this.setState({display : num, resetDisplay: false, operator: ''})
        }     
      }
    ...
    setOperator(operator) {
      ...
      this.setState({display : String(result).slice(0,13), resetDisplay : true})
    }
